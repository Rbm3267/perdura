...
- **Contention** — confidence-weighted `contradicts` edges per claim. It
  prioritizes which question gets worked next, and (Phase 3) decides when to
  escalate from local to frontier or specialist models.
